...
function provideMoon(){
    ...
    image.innerHTML='<img class="photoPlanet" src="assets/destination/image-moon.png" alt="Moon">';
...
function provideMars(){
    ...
    let image=document.getElementById('planetImage')
    image.innerHTML='<img class="photoPlanet" src="assets/destination/image-mars.png" alt="Mars Photo" >';
    setPlanetBorderToDefault();
...
function provideEuropa(){
    ...
    let image=document.getElementById('planetImage')
    image.innerHTML='<img class="photoPlanet" src="assets/destination/image-europa.png" alt="Europa">';
    setPlanetBorderToDefault();
...
function provideTitan(){
    ...
    let image=document.getElementById('planetImage')
    image.innerHTML='<img class="photoPlanet" src="assets/destination/image-titan.png" alt="Moon">';
    setPlanetBorderToDefault();
